document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!editor) {
    console.warn("No element with id='editor' was found. Sidebar is created, but editor-specific logic will be skipped.");
    return;
  }
  ...
  function showConflictModal(localContent, serverContent) {
    ...
    message.textContent = "Another user has updated the text. What do you want to do?";
    ...
    keepMineBtn.textContent = "Keep my text";
    ...
    discardMineBtn.textContent = "Discard my text";
  ...
  if (enableWebSocket) {
    ...
    ws.onmessage = (event) => {
      ...
      if (isTyping) {
        showConflictModal(editor.value, newContent);
      } else {
